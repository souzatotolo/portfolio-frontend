...
export const Projects = () => {
  return (
    ...
    >
      ...
      <div
        id="getInTouch"
        className="md:mt-0 mt-40 flex gap-5 flex-col items-center justify-center"
      >
        ...
        <p className="text-white md:w-[570px] text-center">
          ...
          out to me. I am always excited to connect with new people and discuss
          how I can help bring their vision to life. Looking forward to hearing
          from you soon!
        </p>
